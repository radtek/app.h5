    ...
    <div class="body">
      <router-link :to="{path:'/address-manage'}">
        <rx-row justify="center" class="action" v-for="(item,index) in action" :key="index">
          ...
          <rx-col :span="1">
            <rx-btn icon="goto" type="text"></rx-btn>
          </rx-col>
        </rx-row>
      </router-link>
      <div class="pay">
          ...
          <rx-row justify="center" type="flex">
            <rx-col :span="24">
              <div @click="choosePay('zfb')">
                <rx-row class="main zhifubao" type="flex" justify="center">
                  <rx-col :span="22">
                    <rx-btn class="iconfont icon-zhifubao" type="text"></rx-btn>
              ...
              <div @click="choosePay('wx')">
                <rx-row class="main weixin" type="flex" justify="center">
                  <rx-col :span="22">
                    <rx-btn class="iconfont icon-wxpay" type="text"></rx-btn>
      ...
      <div class="pay-score">
        <rx-row justify="center" type="flex">
          ...
          <rx-col>{{score}}分</rx-col>
        </rx-row>
      </div>
    </div>
    <div class="footer">
      <span class="add">总计： ￥{{allPrice}}+{{score}}积分</span>
      <div class="doPay" @click="doPay()">
        <span>支付</span>
      </div>
    </div>
  </div>
    ...
    toast() {
		...
		__fetch() {
			this.rows = [
				...
				{ price: "100.00", name: "男士羽绒服", num: 2 },
				{ price: "15.00", name: "邮费", num: 1 }
			];
			this.action = [
				{
					name: "张三",
